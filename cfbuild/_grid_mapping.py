...
# from ._constants import GRID_MAPPING_NAMES # F401: Unused
...
def _create_lat_lon_grids(grid_mapping_variable):
    ...
    projection_specifiers = {
        ...
        "rotated_latitude_longitude": {"epsg": None, "required": None},
        "sinusoidal": {
            "epsg": None,
            "proj": "gn_sinu",
        ...
        "vertical_perspective": {"epsg": 9838},
    }
                ...
                for attribute in grid_mapping_attributes:
                    if attribute in netcdf_to_proj_conversion:
                        ...
                        if proj_name in params:
                            proj_string += (
                                f" +{proj_name}={grid_mapping_attributes[attribute]}"
                            )
