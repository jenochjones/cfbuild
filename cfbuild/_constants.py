...
ACDD_ATTRIBUTES = {
    ...
    + "Miscellaneous information about the data, not captured elsewhere",  # Duplicate with CF
    ...
    "keywords_vocabulary": WARNING_MESSAGE
    ...
    "creator_url": WARNING_MESSAGE
    + "The URL of the person (or other creator type specified by the creator_type "
    "attribute) principally responsible for creating this data",
    "creator_institution": WARNING_MESSAGE
    + "The institution of the creator; should uniquely identify the creators "
    "institution",
    "institution": WARNING_MESSAGE
    ...
    "publisher_institution": WARNING_MESSAGE
    + "The institution that presented the data file or equivalent product "
    "to users",
    "publisher_name": WARNING_MESSAGE
    ...
    "publisher_email": WARNING_MESSAGE
    ...
    "publisher_type": WARNING_MESSAGE
    + "a comma-seperated list of key words and/or phrases",
    "contributor_name": WARNING_MESSAGE
    + "The name of any individuals, projects, or institutions that contributed "
    "to the creation of this data",
    "contributor_role": WARNING_MESSAGE
    + "The role of any individuals, projects, or institutions that contributed "
    "to the creation of this data",
    "platform": WARNING_MESSAGE
    + "Name of the platform(s) that supported the sensor data used to create this data "
    "set or product",
    "platform_vocabulary": WARNING_MESSAGE
    + "Controlled vocabulary for the names used in the 'platform' attribute",
    "instrument": WARNING_MESSAGE
    + "Name of the contributing instrument(s) or sensor(s) used to create this data "
    "set or product",
    "instrument_vocabulary": WARNING_MESSAGE
    + "Controlled vocabulary for the names used in the 'instrument' "
    "attribute",
    "cdm_data_type": WARNING_MESSAGE
    + "The data type, as derived from Unidatas Common Data Model Scientific Data "
    "types and understood by THREDDS (Grid, Image, Point, Radial, Station, "
    "Swath, or Trajectory)",
    "acknowledgement": WARNING_MESSAGE
    + "TA place to acknowledge various types of support for the project that"
    " produced this data",
    "geospatial_bounds_crs": WARNING_MESSAGE
    + "The coordinate reference system (CRS) of the point coordinates in the "
    "geospatial_bounds attribute",
    "geospatial_bounds": WARNING_MESSAGE
    + "Describes the datas 2D or 3D geospatial extent in OGCs Well-Known Text "
    "(WKT) Geometry format (reference the OGC Simple Feature Access (SFA) "
    "specification)",
    "geospatial_bounds_vertical_crs": WARNING_MESSAGE
    + "The vertical coordinate reference system (CRS) for the Z "
    "axis of the point coordinates in the geospatial_bounds "
    "attribute",
    "geospatial_lat_min": WARNING_MESSAGE
    + "Describes a simple lower latitude limit; may be part of a 2- or "
    "3-dimensional bounding region",  # Set from dimensional data????
    "geospatial_lat_max": WARNING_MESSAGE
    + "Describes a simple upper latitude limit; may be part of a 2- or "
    "3-dimensional bounding region",  # Set from dimensional data????
    "geospatial_lon_min": WARNING_MESSAGE
    + "Describes a simple longitude limit; may be part of a 2- or "
    "3-dimensional bounding region",  # Set from dimensional data????
    "geospatial_lon_max": WARNING_MESSAGE
    + "Describes a simple longitude limit; may be part of a 2- or "
    "3-dimensional bounding region",  # Set from dimensional data????
    "geospatial_vertical_min": WARNING_MESSAGE
    + "Describes the numerically smaller vertical limit; may be part "
    "of a 2- or 3-dimensional bounding region",
    "geospatial_vertical_max": WARNING_MESSAGE
    + "Describes the numerically larger vertical limit; may be part of a "
    "2- or 3-dimensional bounding region",
    "geospatial_vertical_positive": WARNING_MESSAGE
    + "One of 'up' or 'down'",  # Mirrors CF positive variable attribute
    "geospatial_lat_units": WARNING_MESSAGE
    + "Units for the latitude axis described in 'geospatial_lat_min' and "
    "'geospatial_lat_max' attributes",
    "geospatial_lat_resolution": WARNING_MESSAGE
    + "Information about the targeted spacing of points in latitude",
    "geospatial_lon_units": WARNING_MESSAGE
    + "Units for the longitude axis described in 'geospatial_lon_min' and "
    "'geospatial_lon_max' attributes",
    "geospatial_lon_resolution": WARNING_MESSAGE
    + "Information about the targeted spacing of points in longitude",
    "geospatial_vertical_units": WARNING_MESSAGE
    + "Units for the vertical axis described in 'geospatial_vertical_"
    "min' and 'geospatial_vertical_max' attributes",
    "geospatial_vertical_resolution": WARNING_MESSAGE
    + "Information about the targeted vertical spacing of points",
    "time_coverage_start": WARNING_MESSAGE
    + "Describes the time of the first data point in the data set",  # Set from dimensional data????
    "time_coverage_end": WARNING_MESSAGE
    + "Describes the time of the last data point in the data set",  # Set from dimensional data????
    "time_coverage_duration": WARNING_MESSAGE
    + "Describes the duration of the data set",  # Set from dimensional data?
    "time_coverage_resolution": WARNING_MESSAGE
    + "Describes the targeted time period between each value in the data "
    "set",
...
CF_GLOBAL_ATTRIBUTES = {
    ...
    "history": WARNING_MESSAGE
    + "Documentation of any modifications to the original data",
    "references": WARNING_MESSAGE
    + "Published or web based sorces that document the data or how it was produced",
    "comment": WARNING_MESSAGE
    + "Miscellaneous information about the data or methods used to produce it",
    "external_variables": WARNING_MESSAGE
    + "Variables which are named in the attributes of the file but are not "
    "contained in the file",
    "featureType": WARNING_MESSAGE
    + "Specifies the type of data in the file/group. Set as 'point', 'timeSeries',"
...
CF_ALL_COORDINATE_VARIABLE_ATTRIBUTES = {
    ...
    "actual_range": WARNING_MESSAGE
    + "The smallest and the largest valid nonmissing values occurring in the variable",
    "_FillValue": WARNING_MESSAGE
    + "A value used to represent missing or undefined data. Allowed for auxiliary "
...
CF_X_COORDINATE_VARIABLE_ATTRIBUTES = {"standard_name": "longitude", "axis": "X"}

CF_Y_COORDINATE_VARIABLE_ATTRIBUTES = {"standard_name": "latitude", "axis": "Y"}
...
CF_AUXILIARY_COORDINATE_VARIABLE_ATTRIBUTES = {
    ...
    + "A value used to represent missing or undefined data. Allowed for auxiliary "
    "coordinate variables but not allowed for coordinate variables",
    "missing_value": WARNING_MESSAGE
    + "A value or values used to represent missing or undefined data. Allowed for "
...
CF_DATA_VARIABLE_ATTRIBUTES = {
    "long_name": WARNING_MESSAGE
    + "A descriptive name that indicates a variable's content",
    "standard_name": WARNING_MESSAGE
    + "A standard name that references a description of a variable's content in the "
...
CF_DOMAIN_VARIABLE_ATTRIBUTES = {
    ...
    + "A descriptive name that indicates a variable's content",
    "geometry": WARNING_MESSAGE + "Identifies a variable that defines geometry",
    "cell_measures": WARNING_MESSAGE
    + "Identifies variables that contain cell areas or volumes",
    "coordinate_interpolation": WARNING_MESSAGE
    + "Indicates that coordinates have been compressed by sampling and "
    "identifies the tie point coordinate variables and their associated "
    "interpolation variables",
    "coordinates": WARNING_MESSAGE
    + "Identifies auxiliary coordinate variables, label variables, and alternate "
    "coordinate variables",
    "grid_mapping": WARNING_MESSAGE
    + "Identifies a variable that defines a grid mapping",
    "dimensions": WARNING_MESSAGE
...
CF_GEOMETRY_CONTAINER_VARIABLE_ATTRIBUTES = {
    ...
    "grid_mapping": WARNING_MESSAGE
    + "Identifies a variable that defines a grid mapping",
    "interior_ring": WARNING_MESSAGE
    + "Identifies a variable that indicates if polygon parts are interior rings "
    "(i.e., holes) or not",
    "node_coordinates": WARNING_MESSAGE
    + "Identifies variables that contain geometry node coordinates",
    "node_count": WARNING_MESSAGE
    + "Identifies a variable indicating the count of nodes per geometry",
    "part_node_count": WARNING_MESSAGE
...
CF_OTHER_ATTRIBUTES = {
    "instance_dimension": WARNING_MESSAGE
    + "An attribute which identifies an index variable and names the instance "
    ...
    "features.",
    "sample_dimension": WARNING_MESSAGE
    + "An attribute which identifies a count variable and names the sample "
...
GRID_MAPPING_NAMES = {
    ...
    "geostationary": {
        "map_parameters": [
            ...
            {"sweep_angle_axis": ["x", "y"]},
            {"fixed_angle_axis": ["x", "y"]},
            {"false_easting": 0},
            {"false_northing": 0},
        ],
        "map_coordinates": [
            "pprojection_x_angular_coordinate",
    ...
    "polar_stereographic": {
        "map_parameters": [
            ...
            {"latitude_of_projection_origin": [90, -90]},
            ["standard_parallel", "scale_factor_at_projection_origin"],
            {"false_easting": 0},
            {"false_northing": 0},
        ],
...
GRID_MAPPING_OPTIONAL_ATTRIBUTES = [
    "crs_wkt",
    "earth_radius",
    "geographic_crs_name",
    "geoid_name",
