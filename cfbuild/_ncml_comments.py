...
BOUNDARY_VARIABLE_ATTRIBUTES_WARNING = (
    "INFO - Boundary variables are part of the metadata of the associated "
    "variable and does not need attributes."
)

STANDARD_NAME_WARNING = [
    "WARNING - The given standard name (",
    ") was not found in the standard name table: "
...
OPENDAP_RESERVED_KEYWORDS_WARNING = [
    ...
    '" is a reserved OPeNDAP keyword. If the '
...
DATA_TYPE_WARNING = [
    ...
    '" is  not compatible with OPeNDAP. Please specify an int16, '
    "int32, float32, float64, str, or char datatype.",
]

ADD_GRID_MAPPING_VARIABLE = (
    "WARNING - a grid mapping variable should be added that specifies the coordinate"
...
MISSING_VALUE_WARNING = (
    "WARNING - The missing_value is within the valid data range. Please specify a missing_value "
    "outside the valid data range."
)

MONOTONIC_VALUES_ERROR = [
    "ERROR - The coordinate variable (",
    ") must have monotonically increasing or decreasing "
...
VALID_RANGE_WARNING = (
    "WARNING - The actual range of the data is outside the valid range"
)

VARIABLE_NAME_WARNING = (
    "WARNING - Variable names should start with a letter and be composed of letters, numbers, "
    "and underscores."
)

FILL_VALUE_WARNING = (
    "WARNING - The _FillValue is within the valid data range. Please specify a _FillValue outside "
