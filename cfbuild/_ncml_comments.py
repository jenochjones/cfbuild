COMMENT_DICT = {
    ...
    'STANDARD_NAME_WARNING': [
        'WARNING - The given standard name (',
        ') was not found in the standard name table: https://cfconventions.org/Data/cf-standard-names/'
    ...
    'UNITS_WARNING': [
        'WARNING - The given units (',
        ') are not equivalent to the canonical units for the given standard name (',
        ')'
    ],
    'OPENDAP_RESERVED_KEYWORDS_WARNING': [
        'WARNING - The variable name "',
        '" is a reserved OPeNDAP keyword. If the name is not changed, the dataset will not work properly with OPeNDAP.'
    ],
    'DATA_TYPE_WARNING': [
        'WARNING - The variable datatype "',
        '" is  not compatible with OPeNDAP. Please specify an int16, int32, float32, float64, str, or char datatype.'
    ],
    'ADD_GRID_MAPPING_VARIABLE': 'WARNING - a grid mapping variable should be added that specifies the '
                                 'coordinate reference system used.',
    'MISSING_VALUES_ERROR': [
        'ERROR - The coordinate variable (',
        ') is missing values. Please specify new values.'
    ],
    'MISSING_VALUE_WARNING': 'WARNING - The missing_value is within the valid data range. '
                             'Please specify a missing_value outside the valid data range.',
    'MONOTONIC_VALUES_ERROR': [
        'ERROR - The coordinate variable (',
        ') must have monotonically increasing or decreasing values. '
        'Please specify new values.'
    ],
    'CANT_GET_VALUES_WARNING': [
        'INFO - Cannot check values for ',
        '.'
    ],
    ...
    'VARIABLE_NAME_WARNING': 'WARNING - Variable names should start with a letter and be composed of letters, '
                             'numbers, and underscores.',
    'FILL_VALUE_WARNING': 'WARNING - The _FillValue is within the valid data range. Please specify a _FillValue '
